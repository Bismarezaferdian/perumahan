...
import WrapLayout from "@/app/WrappLayout";
...
const Fasilitas = () => {
  ...
  return (
    ...
    <motion.div
      ref={ref}
      className="container  mx-auto overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]"
    >
      <div className="-mx-4 flex flex-wrap">
        <div className="w-full px-4">
          <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
            ...
            <h2 className="mb-3 text-xl font-bold leading-[1.2]   dark:text-white sm:text-4xl md:text-[40px]">
              FASILITAS SEKITAR
            </h2>
      ...
      <div className=" grid grid-cols-2 md:grid-cols-4 gap-1">
        <ServiceCard
          ...
          animate={mainControl}
          variants={variants}
          title="Dekat Sekolahan"
          details="Dekat dengan sekolahan mulai dari SD,SMP dan SMA"
          icon={
            <UserIcon className="h-6 w-6 text-gray-500 dark:text-gray-50" />
            //   <svg
            //     width="36"
            //     height="36"
            //     viewBox="0 0 36 36"
        ...
        <ServiceCard
          ...
          details="Tersedia pasar traditional untuk memenuhi kebutuhan rumah tangga anda."
          icon={
            <svg
              width="36"
              height="36"
        ...
        <ServiceCard
          ...
          variants={variants}
          title="Rumah Sakit"
          details="Lokasi strategis dekat dengan rumah sakit,"
          icon={
            <svg
              width="36"
              height="36"
        ...
        <ServiceCard
          ...
          variants={variants}
          title="Rumah Asri"
          details="Desain hunian yang selaras dengan alam. Rumah hadap utara dan selatan, menggunakan solar water heater, rainwater harvesting."
          icon={
            <svg
              width="36"
              height="36"
        ...
        <ServiceCard
          ...
          variants={variants}
          animate={mainControl}
          title="30 Menit Ke Pintu Toll"
          details="memiliki akses langsung ke Tol Jakarta-Merak dan hanya sekitar 30 menit ke Jakarta dan Bandara Soekarno-Hatta."
          icon={
            <svg
              width="36"
              height="36"
...
const ServiceCard = ({
  ...
  return (
    ...
    <motion.div
      ...
      className="w-full "
    >
      <div className="mb-9 rounded-[20px] flex flex-col justify-center p-2 shadow-2 md:px-7 xl:px-10 ">
        <div className="mb-8 flex h-[70px] items-center justify-center rounded-2xl w-full ">
          {icon}
        </div>
        <h4 className=" flex items-center justify-center mb-[14px] text-xl font-semibold text-dark dark:text-white">
          {title}
        </h4>
        <p className="text-center  w-full">{details}</p>
      </div>
    </motion.div>
    // </>
  );
